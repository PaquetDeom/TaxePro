...
public class TaCrudFormFactory extends GridLayoutCrudFormFactory<TaItem> {
	...
	private static List<PropertyInfo> getColumnsInfo(Class<TaItem> domainType) {
	...
	public TaCrudFormFactory(Class<TaItem> domainType) {
	...
	@Override
	public Component buildNewForm(CrudOperation operation, TaItem domainObject, boolean readOnly,
		...
		BeanFieldGroup fieldGroup = new TaBeanFieldGroup(domainObject.getClass());
